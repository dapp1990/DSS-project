...
These tests fail with the current implementation, that only covers the assignment. They are meant as the first step in future improvements, following the test-driven design methodology.
